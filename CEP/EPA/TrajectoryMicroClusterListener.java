 ...
 */
public class TrajectoryMicroClusterListener implements UpdateListener{
    
    static Logger LOG = Logger.getLogger(TrajectoryMicroClusterListener.class);
    
    @Override
    public void update(EventBean[] ebs, EventBean[] ebs1) {/*do nothing*/ }
}
