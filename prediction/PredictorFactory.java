...
public class PredictorFactory {
    ...
    public static Predictor getPredictor(){
        ...
        PredictorConfig config = ConfigProviderFactory.getConfig().getPredictorConfig();
        switch(config.getType()){
            case BASIC:
                predictor = new BasicPredictor(ConfigProviderFactory.getConfig().getPredictorConfig());
                break;
            case ENHANCED:
                predictor = new EnhancedPredictor(ConfigProviderFactory.getConfig().getPredictorConfig());
                break;
        }             
